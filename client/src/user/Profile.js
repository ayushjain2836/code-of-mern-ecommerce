...
const [auth,setAuth]=useAuth()
 ...
 //get user data
 useEffect(()=>{const {email,name,phone,address,password} =auth.user;
 setName(name)
 setPhone(phone)
 setEmail(email)
 setAddress(address)
  ...
  return (
    ...
    <div className='container-fluid m-3 p-3'>
      <div className='row'>
        ...
        <div className='col-md-9'> <div className='register'>
  ...
  <div className="mb-3">
    ...
    <div className="mb-3">
    <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} className="form-control" id="exampleInputEmail1" placeholder='Email'  disabled/>
    </div>
  <div className="mb-3">
  ...
  <div className="mb-3">
    ...
    <div className="mb-3">
    <input type="text" value={address} onChange={(e)=>setAddress(e.target.value)} className="form-control" id="exampleInputAddress1" placeholder='Address' />
    </div>
